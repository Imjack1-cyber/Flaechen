package de.m4automotive.logic.Kreise;
...
public class KreisLogic {
	...
	private final static Logger LOG = LogManager.getLogger(KreisLogic.class);

	public void berechneKreise(HttpServletRequest request, HttpServletResponse response)
		...
		DF df = new DF();
		kreis.setDecimalFormat(df.getDecimalFormat(decimalPlaces)); // Pass decimalPlaces
