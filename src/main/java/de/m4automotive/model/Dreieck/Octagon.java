...
public class Octagon {
	...
	private String formatValue(double value) {
		...
		if (this.df == null) {
			System.err.println(
					"WARNING: Octagon.formatValue - DecimalFormat (df) is null. Returning unformatted value: " + value); // Log
																															// warning
		...
		try {
			...
			System.err.println("ERROR: Octagon.formatValue - Error formatting value " + value + " with pattern '"
