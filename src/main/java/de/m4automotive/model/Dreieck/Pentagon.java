...
public class Pentagon {
	...
	private String formatValue(double value) {
		...
		if (this.df == null) {
			System.err
					.println("WARNING: Pentagon.formatValue - DecimalFormat (df) is null. Returning unformatted value: "
							+ value); // Log
										// warning
		...
		try {
			...
			System.err.println("ERROR: Pentagon.formatValue - Error formatting value " + value + " with pattern '"
