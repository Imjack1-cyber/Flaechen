...
public class Prisma {
	...
	private String formatValue(double value) {
		...
		if (this.df == null) {
			System.err.println(
					"WARNING: Prisma.formatValue - DecimalFormat (df) is null. Returning unformatted value: " + value); // Log
																														// warning
		...
		try {
			...
			System.err.println("ERROR: Prisma.formatValue - Error formatting value " + value + " with pattern '"
