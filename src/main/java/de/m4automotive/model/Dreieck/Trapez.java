...
public class Trapez {
	...
	private String formatValue(double value) {
		...
		if (this.df == null) {
			System.err.println(
					"WARNING: Trapez.formatValue - DecimalFormat (df) is null. Returning unformatted value: " + value); // Log
																														// warning
		...
		try {
			...
			System.err.println("ERROR: Trapez.formatValue - Error formatting value " + value + " with pattern '"
